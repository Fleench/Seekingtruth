...
export const AboutCard: QuartzComponentConstructor = () => {
  return () => (
...
export const TimelineCard: QuartzComponentConstructor = () => {
  const events = [
...
export const QuoteCard: QuartzComponentConstructor = () => {
  return () => (
...
export const RelatedPagesCard: QuartzComponentConstructor = ({ fileData, allFiles }) => {
  return () => {
    if (!fileData.links || fileData.links.length === 0) return null
    return (
      <div class="rounded-2xl shadow-md p-4 bg-white dark:bg-gray-900">
